...
ARTICLE:  "4DStroll.adsoda" "4DStroll.adsoda" "ADSODA : Arbitrary-Dimensional Solid Object Display Algorithm"
$nl
"ADSODA is multidimensional handler which was first " 
{ $emphasis "written in C++ by Greg Ferrar" } 
"." 
$nl
"For full explanation on ADSODA look at the page " { $url "http://www.flowerfire.com/ADSODA/" }
$nl
"Useful words are described on the following pages: "
